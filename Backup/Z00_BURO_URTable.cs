...
{
  /// <summary>
  /// A typed collection of Z00_BURO_UR elements.
  /// </summary>
  [Serializable]
  public class Z00_BURO_URTable : SAPTable 
  {
  
    /// <summary>
    /// Returns the element type Z00_BURO_UR.
    /// </summary>
    /// <returns>The type Z00_BURO_UR.</returns>
    public override Type GetElementType() 
    {
        return (typeof(Z00_BURO_UR));
    }

    /// <summary>
    /// Creates an empty new row of type Z00_BURO_UR.
    /// </summary>
    /// <returns>The newZ00_BURO_UR.</returns>
    public override object CreateNewRow()
    { 
        return new Z00_BURO_UR();
    }
     
    /// <summary>
    /// The indexer of the collection.
    /// </summary>
    public Z00_BURO_UR this[int index] 
    {
        get 
        {
            return ((Z00_BURO_UR)(List[index]));
        }
        set 
        {
            List[index] = value;
