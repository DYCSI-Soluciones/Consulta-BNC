...
{
  /// <summary>
  /// A typed collection of Z00_BURO_SC elements.
  /// </summary>
  [Serializable]
  public class Z00_BURO_SCTable : SAPTable 
  {
  
    /// <summary>
    /// Returns the element type Z00_BURO_SC.
    /// </summary>
    /// <returns>The type Z00_BURO_SC.</returns>
    public override Type GetElementType() 
    {
        return (typeof(Z00_BURO_SC));
    }

    /// <summary>
    /// Creates an empty new row of type Z00_BURO_SC.
    /// </summary>
    /// <returns>The newZ00_BURO_SC.</returns>
    public override object CreateNewRow()
    { 
        return new Z00_BURO_SC();
    }
     
    /// <summary>
    /// The indexer of the collection.
    /// </summary>
    public Z00_BURO_SC this[int index] 
    {
        get 
        {
            return ((Z00_BURO_SC)(List[index]));
        }
        set 
        {
            List[index] = value;
