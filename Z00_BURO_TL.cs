...
namespace ZConsultaBuro
{
  ...
  /// 
  /// </summary>
  [RfcStructure(AbapName ="Z00_BURO_TL" , Length = 353, Length2 = 706)]
  [Serializable]
  public class Z00_BURO_TL : SAPStructure
  {
    ...
    [RfcField(AbapName = "MONTO_ULTIMO", RfcType = RFCTYPE.RFCTYPE_CHAR, Length = 9, Length2 = 18, Offset = 344, Offset2 = 688)]
    [XmlElement("MONTO_--5fULTIMO")]
    public string Monto_Ultimo
    {
        get
        {
            return _Monto_Ultimo;
        }
        set
        {
            _Monto_Ultimo = value;
